...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.githubusercontent.com/MuluuJelekk/Muluu/master/client.conf"
...
wget -O /etc/squid/squid.conf "https://raw.github.com/choirulanam217/script/master/conf/squid.conf"
